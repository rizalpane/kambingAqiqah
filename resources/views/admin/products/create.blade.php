...
<div class="container-fluid py-5">
    <div class="row mb-4">
        <div class="col-md-6">
            <h3 class="display-6">Tambah Produk Baru</h3>
        </div>
    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('category') is-invalid @enderror" 
                            ...
                            <option value="Jantan" {{ old('category', 'Jantan') == 'Jantan' ? 'selected' : '' }}>Jantan</option>
                            <option value="Betina" {{ old('category') == 'Betina' ? 'selected' : '' }}>Betina</option>
                        </select>
                        @error('category')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
