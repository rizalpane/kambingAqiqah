...
<head>
    ...
    <title>@yield('title', 'SiKambing - Admin Panel')</title>
...
<body>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end notification-dropdown" aria-labelledby="orderNotifications">
                        ...
                        <div class="notification-footer">
                            <a href="{{ route('admin.order') }}" class="text-center d-block">Lihat Semua Pesanan</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end notification-dropdown" aria-labelledby="systemNotifications">
                        ...
                        <div class="notification-footer">
                            <a href="{{ route('admin.history') }}" class="text-center d-block">Lihat Riwayat</a>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function fetchSystemNotifications() {
            fetch('{{ route("admin.notifications.system") }}')
                .then(response => response.json())
                .then(data => {
