...
<head>
  ...
  <title>@yield('title', 'SiKambing - Layanan Aqiqah Terpercaya')</title>
        ...
        <div class="d-flex gap-2 flex-column flex-lg-row">
          @auth
            @if(auth()->user()->role === 'admin')
              <a class="btn btn-nav-register" href="{{ route('admin.dashboard') }}" role="button">
                <i class="bi bi-speedometer2 me-2"></i>Dashboard Admin
              </a>
            @else
              <a class="btn btn-nav-register" href="{{ route('user.dashboard') }}" role="button">
