<?php $__env->startSection('title', 'Dashboard - Produk Aqiqah'); ?>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="hero-content">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            ...
                            <form action="<?php echo e(route('auth.logout')); ?>" method="POST" class="d-none d-lg-block">
                                <?php echo csrf_field(); ?>
                        ...
                        <div class="d-flex gap-3 flex-wrap align-items-center">
                            ...
                            <form action="<?php echo e(route('auth.logout')); ?>" method="POST" class="d-lg-none">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn-logout-hero">
                                    <i class="bi bi-box-arrow-right"></i>
                                    <span>Logout</span>
                ...
                <div class="col-lg-4 d-none d-lg-block text-center">
                    <img src="<?php echo e(asset('images/goat.png')); ?>" alt="Kambing Aqiqah" class="hero-image">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 g-4" id="productsContainer">
                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col product-item" data-category="<?php echo e(strtolower($product->category)); ?>" data-name="<?php echo e(strtolower($product->name)); ?>">
                        <div class="product-card h-100">
                            ...
                            <div class="product-image-wrapper">
                                ...
                                <?php else: ?>
                                    <img src="<?php echo e(asset('images/goat.png')); ?>" class="product-image" alt="default">
                                <?php endif; ?>
                                
                                <!-- Category Badge -->
                                <span class="category-badge badge-<?php echo e(strtolower($product->category)); ?>">
                                    <i class="bi bi-tag-fill me-1"></i><?php echo e($product->category); ?>
                            ...
                            <div class="product-body">
                                ...
                                <div class="product-price">
                                    ...
                                    <span class="price-value">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></span>
                                </div>
                                ...
                                <div class="product-meta">
                                    ...
                                    <div class="meta-item">
                                        ...
                                        <span>Stok: <strong><?php echo e($product->stock); ?></strong> Ekor</span>
                                    </div>
                                </div>
                                ...
                                <div class="product-actions">
                                    <?php if($product->stock > 0): ?>
                                        <a href="<?php echo e(route('user.checkout', $product->id)); ?>" class="btn btn-primary btn-buy">
                                            <i class="bi bi-cart-plus me-2"></i>Beli Sekarang
                                        </a>
                                        <button class="btn btn-outline-primary btn-detail" data-bs-toggle="modal" data-bs-target="#detailModal<?php echo e($product->id); ?>">
                                            <i class="bi bi-eye"></i>
                                        </button>
                                    <?php else: ?>
                    ...
                    <!-- Detail Modal -->
                    <div class="modal fade" id="detailModal<?php echo e($product->id); ?>" tabindex="-1">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="text-center mb-3">
                                        <?php if($product->image): ?>
                                            <img src="<?php echo e(asset($product->image)); ?>" class="img-fluid rounded" alt="<?php echo e($product->name); ?>" style="max-height: 250px;">
                                        <?php else: ?>
                                            <img src="<?php echo e(asset('images/goat.png')); ?>" class="img-fluid rounded" alt="default" style="max-height: 250px;">
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <table class="table table-borderless">
                                        <tr>
                                            ...
                                            <td><strong><?php echo e($product->category); ?></strong></td>
                                        </tr>
                                        <tr>
                                            <td><i class="bi bi-cash me-2"></i>Harga</td>
                                            <td><strong class="text-primary">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></strong></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($product->stock); ?> Ekor</td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <?php if($product->stock > 0): ?>
                                        <a href="<?php echo e(route('user.checkout', $product->id)); ?>" class="btn btn-primary">
                                            <i class="bi bi-cart-plus me-2"></i>Beli Sekarang
                                        </a>
                                    <?php endif; ?>
                                </div>
