<?php $__env->startSection('title', 'Beranda - Layanan Aqiqah Terpercaya'); ?>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="hero-content">
                    ...
                    <h1 class="hero-title">
                        <?php echo e(\App\Models\Setting::get('site_title', 'Selamat Datang')); ?>

                    </h1>
                    
                    <p class="hero-subtitle">
                        <?php echo e(\App\Models\Setting::get('site_subtitle', 'Layanan Aqiqah Terpercaya dan Berkualitas')); ?>

                    </p>
                    
                    <?php if(\App\Models\Setting::get('site_description')): ?>
                        <p class="hero-description">
                            <?php echo e(\App\Models\Setting::get('site_description')); ?>
    ...
    <div class="container">
        ...
        <div class="text-center">
            <p class="footer-copyright mb-0">
                &copy; <?php echo e(date('Y')); ?> SiKambing. All rights reserved. Made with <i class="bi bi-heart-fill text-danger"></i>
            </p>
        </div>
    </div>
</footer>
...
<?php echo $__env->make('layouts.layoutMain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelProject\resources\views/index.blade.php ENDPATH**/ ?>